package com.base.utils.generator;
/**
...
public class EntityUtil {
    ...
    private final String moduleName = "finance_db";
    ...
    private final String bean_package = "com.pingan.haofang.financial.persistence";

    private final String mapper_package = "com.pingan.haofang.financial.repository.finance";
    ...
    public static void main(String[] args) throws RuntimeException {
        try {
            List<String> tables = new ArrayList<String>();
            tables.add("t_business");
            tables.add("t_finance_business");
            tables.add("t_fin_business_inform");
            tables.add("t_business_notification");
            tables.add("t_fin_business_act_callback");
            tables.add("t_finance_payment");
            tables.add("t_hfb_transfer_order");
            tables.add("t_email_log");
